            ...
            <div class="col-md-12">
                <div class="single-page-header-inner">
                    <div class="left-side">
                        ...
                        <a href="<?php _esc($config['site_url']);?>hire" class="button button-sliding-icon ripple-effect" tabindex="0" style="width: 294px;">Hire Me <i class="icon-material-outline-arrow-right-alt"></i></a> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="sidebar-container">
                <?php if($profile_usertype == "user"){ ?>
                    ...
                    <div class="profile-overview">
                        ...
                        <div class="overview-item"><strong><?php _esc(2000)?></strong><span><?php _e("Daily Rate") ?></span></div>
