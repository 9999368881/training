                        ...
                        <div class="content with-padding js-accordion-body">
                            ...
                            <form method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-12">
                                        <div class="submit-field">
                                            <h5><?php _e("Daily Rate") ?> *</h5>
                                            <div class="input-with-icon">
                                                <input class="with-border margin-bottom-0" type="number" placeholder="<?php _e("Daily Rate") ?>"
                                                       name="daily_rate" value="<?php _esc($daily_rate)?>" >
                                                <i class="currency"><?php _esc($config['currency_sign'])?></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-md-12">
                                        <div class="submit-field">
                                            ...
                                            <div class="input-with-icon-left">
                                                ...
                                                <input type="tel" name="phone" class="with-border margin-bottom-0"
